...
const UploadCatagoryModel = ({ close, fetch }) => {
  ...
  return (
    <>
      <div className="fixed top-0 bottom-0 right-0 left-0 bg-black/50 p-2 flex justify-center items-center">
        <div className="bg-white min-w-sm sm:min-w-xl md:min-w-2xl lg:min-w-4xl p-2 px-4 rounded flex flex-col relative">
          ...
          <h1 className="text-xl font-bold">Upload Catagory Model</h1>
